...
public class TeamSeasonStats {
    ...
    public TeamSeasonStats(int FG, int FGA, double FGP, int FG3, int FG3A, double FG3P, int FT,
                           int FTA, double FTP, int ORB, int DRB, int TRB, int AST, int STL, int TOV,
                           int PTS, int PF, int BLK, String season, Teams team) {
        this.FG = FG;
        this.FGA = FGA;
        this.FGP = FGP;
        this.FG3 = FG3;
